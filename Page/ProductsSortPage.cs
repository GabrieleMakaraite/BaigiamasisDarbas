...
namespace BaigiamasisDarbas.Page
{
    public class ProductsSortPage : BasePage
    {
        ...
        private const string ResultText2 = "Hemp Bath Salts - Adjustable Ring Collection";
        private const string ResultText3 = "Lavender Bath Salts - Adjustable Ring Collection";
        private const string ResultText4 = "Peach Sugar Kiss Bath Salts - Adjustable Ring Collection";
        ...
        private IWebElement ResultTextElement2 => Driver.FindElement(By.CssSelector("#prod-6618688553054 > div.ci > div.product-title > a > h3"));
        private IWebElement ResultTextElement3 => Driver.FindElement(By.CssSelector("#prod-6618688356446 > div.ci > div.product-title > a > h3"));
        private IWebElement ResultTextElement4 => Driver.FindElement(By.CssSelector("#prod-6618688421982 > div.ci > div.product-title > a > h3"));
